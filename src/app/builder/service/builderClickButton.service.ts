...
export class BuilderClickButtonService {
  ...
  getFormlyConfig(node: any) {
    ...
    return {
      ...
      optionDisabled: node.formly[0].fieldGroup[0].templateOptions.config?.['optionDisabled'],
      optionHide: node.formly[0].fieldGroup[0].templateOptions.config?.['optionHide'],
      ...
      firstBtnText: node.formly[0].fieldGroup[0].templateOptions.config?.['firstBtnText'],
      secondBtnText: node.formly[0].fieldGroup[0].templateOptions.config?.['secondBtnText'],
      minuteStep: node.formly[0].fieldGroup[0].templateOptions.config?.['minuteStep'],
