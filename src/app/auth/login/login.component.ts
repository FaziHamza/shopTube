...
import { AuthenticationResult, EventMessage, InteractionStatus, InteractionType, PopupRequest, RedirectRequest } from '@azure/msal-browser';
...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.msalBroadcastService.msalSubject$
      .pipe(
        filter((msg: EventMessage) => msg.eventType.toString() === EventType.LOGIN_SUCCESS),
