...
@Component({
  ...
  <div [ngClass]="{'errorClass': hasError && to['additionalProperties']?.requiredMessage }" class="flex flex-wrap" [dir]="to['additionalProperties']?.formatAlignment || 'ltr'">
    ...
    <div [nzTooltipTitle]="hasError && to['additionalProperties']?.requiredMessage ? to['additionalProperties']?.requiredMessage : ''" nz-tooltip [class]="to['additionalProperties']?.wrapperInputClass ? to['additionalProperties']?.wrapperInputClass : 'w-2/3 column-form-input form-control-style v-body-border'" style="padding: 0px">
