...
@Component({
  ...
  <div class="example-input">
    <input [ngClass]="to['additionalProperties']?.wrapper && to['additionalProperties']?.wrapper == 'floating_filled' || to['additionalProperties']?.wrapper == 'floating_outlined' ? to['additionalProperties']?.floatFieldClass : ''" [placeholder]="to.placeholder" nz-input [formControl]="formControl" (ngModelChange)="onChange($event)" [nzAutocomplete]="auto" />
